...
class SideBarUniversityUser extends Component {
  constructor(props) {
    super(props);
...
const MyComponent = connect(mapStateToProps)(SideBarUniversityUser);
