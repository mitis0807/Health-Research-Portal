...
let that;
const { error } = Modal;
class SideBarSeniorStatistician extends Component {
  constructor(props) {
    super(props);
...
: [
  ...
  <Menu.Item key="manageRequests" style={{ paddingLeft: '28px !important', paddingRight: '20px !important' }} disabled >
   ...
   <Menu.Item key="reports" style={{ paddingLeft: '28px !important', paddingRight: '20px !important' }} disabled >
   <Link to="/reports">
...
const MyComponent = connect(mapStateToProps)(SideBarSeniorStatistician);
